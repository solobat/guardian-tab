...
export const ToggleIcon = ({
  ...
  <button
    onClick={onClick}
    className="fixed top-4 right-4 z-10 bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-full shadow-lg transition-colors duration-200"
  >
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="h-6 w-6"
...
export const AddNoteIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V19.5a2.25 2.25 0 002.25 2.25h.75m0-3H21m-3.75 3h1.5m-1.5-3h1.5m-6-3h1.5m-1.5-3h1.5m-1.5-3h1.5M10.5 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5M21 12v3m0 0v3m0-3h-3m3 0h-3"
    />
  </svg>
)
...
// 关闭仓位图标
export const ClosePositionIcon = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
